function [RR,semSim,lme,amp_std,f0,resolve] = backwardsModel_KP(stim,pred,sem,stim_e_f_r,Fs,tWind)
...
%
% pred : Time series of the predicted speech envelope based on the backwards TRF.
% This can be computed with mTRFpredict/ mTRFtrain or mTRFcrossval. {1,nTrials}(Samples,
% nSubjects)
%
